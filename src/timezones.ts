// Adapted from https://raw.githubusercontent.com/tc39/proposal-intl-enumeration/master/polyfill/timeZones.js
// Which is © 2020 Google, Ecma International, licensed under MIT
...
function getSupportedTimeZones() {
  ...
  const TIMEZONES_IN_CLDR = [
    ...
    "America/Halifax", "America/Havana", "America/Hermosillo", "America/Indiana/Knox", "America/Indiana/Marengo",
    ...
    "America/Jujuy", "America/Juneau", "America/Kentucky/Monticello", "America/Kralendijk", "America/La_Paz",
    ...
    "America/Port_of_Spain", "America/Port-au-Prince", "America/Porto_Velho", "America/Puerto_Rico",
    ...
    "Asia/Famagusta", "Asia/Gaza", "Asia/Hebron", "Asia/Hong_Kong", "Asia/Hovd", "Asia/Irkutsk",
    "Asia/Jakarta", "Asia/Jayapura", "Asia/Jerusalem", "Asia/Kabul", "Asia/Kamchatka", "Asia/Karachi",
    "Asia/Katmandu", "Asia/Khandyga", "Asia/Kirov", "Asia/Krasnoyarsk", "Asia/Kuala_Lumpur",
    ...
    "Atlantic/Bermuda", "Atlantic/Canary", "Atlantic/Cape_Verde", "Atlantic/Faeroe", "Atlantic/Madeira",
    ...
    "Australia/Melbourne", "Australia/Perth", "Australia/Sydney", "CST6CDT", "Etc/GMT", "EST5EDT",
    ...
    "Indian/Maldives", "Indian/Mauritius", "Indian/Mayotte", "Indian/Reunion", "MST7MDT",
    ...
    "Pacific/Tongatapu", "Pacific/Truk", "Pacific/Wake", "Pacific/Wallis", "PST8PDT"
  ];

  function isSupported(timeZone: string) {
    try {
      const nf = new Intl.DateTimeFormat("en", { timeZone });
      const o = nf.resolvedOptions().timeZone;
      if (o == timeZone) { return true; }
...
const supportedTimeZones = getSupportedTimeZones().filter(tz => tz.includes('/'))

export function normalizeCity(tz: string) {
  const idx = tz.lastIndexOf('/')
  return tz.substring(idx + 1).replaceAll('_', ' ')
}

const cities = supportedTimeZones.map(tz => {
  return [tz, normalizeCity(tz)]
})

export { supportedTimeZones, cities }
